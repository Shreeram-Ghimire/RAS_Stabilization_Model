...
====================================
Predicts biofilter/nitrogen-cycle stabilization time in a Recirculating
Aquaculture System (RAS) using:
...
# ----------------------------------------------------------------------
# 1. BASE CONDITIONS (this is a single configuration point)
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# 3. STABILITY ANALYSIS (Jacobian and eigenvalues)
# ----------------------------------------------------------------------
